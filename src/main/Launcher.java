...
public class Launcher {
	private final static String filenameKosaraju = "/graph16";	// by default, we expect data to be at same level as src/ folder
	private final static String filenameSat = "/sat10";			// check makeXXXGraph() functions to change that.
	
	private final static boolean showResults = true;			// should we display the arrays ? convenient to check tiny instances.
